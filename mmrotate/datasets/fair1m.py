...
# from BboxToolkit.BboxToolkit.move import translate
# from BboxToolkit.BboxToolkit.datasets import DOTAio
import cv2
...
class FAIR1MDataset(CustomDataset):
    ...
    PALETTE = [
        # airplane
        (255, 128, 0), (147, 155, 116), (0, 204, 102), (0, 255, 0),
        (165, 42, 42), (255, 0, 255), (255, 250, 205), (255, 193, 193),
        (255, 0, 0), (138, 43, 226), (189, 183, 107),
        # ship
        (0, 255, 255), (0, 139, 139), (0, 51, 153), (255, 255, 0), (238, 232, 170),
        (255, 228, 181), (255, 69, 0), (85, 107, 47),
        (173, 255, 47),
        # vehicle
        (124, 252, 0), (0, 100, 0), (204, 255, 153),
        (127, 255, 170), (64, 224, 208), (72, 209, 204), (102, 204, 255),
        (0, 191, 255), (204, 204, 255), (204, 204, 0),
        # court
        (186, 85, 211), (255, 153, 255), (199, 21, 133),
        (220, 20, 60),
        # road
        (95, 158, 160), (204, 255, 255), (139, 69, 19)
    ]
    ...
    def _results2submission(self, id_list, dets_list, out_folder=None):
        ...
        file_objs = [open(f, 'w', encoding='utf-8') for f in files]
