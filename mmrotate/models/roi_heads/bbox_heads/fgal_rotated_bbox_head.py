...
class FGALRotatedBBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(FGALRotatedBBoxHead, self).__init__(init_cfg)
        ...
        self.num_classes = num_classes['sub']
        self.num_dom_classes = num_classes['dom']
        ...
        if self.with_reg:
            out_dim_reg = 5 if reg_class_agnostic else 5 * self.num_classes
