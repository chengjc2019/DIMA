...
class FGALRoITransRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        super(FGALRoITransRoIHead, self).__init__(init_cfg)
    ...
    def _bbox_forward(self, stage, x, rois):
        ...
        return bbox_results
    def _bbox_forward1(self, stage, x, rois):
        """Box head forward function used in both training and testing.
        ...
        bbox_feats = bbox_roi_extractor(x[:bbox_roi_extractor.num_inputs],
                                        rois)
        # do not support caffe_c4 model anymore
        coarse_cls_score, fine_cls_score, coarse_cls_score1, fine_cls_score1, cls_score, bbox_pred = bbox_head(
            bbox_feats)
    ...
    def _bbox_forward_train(self, stage, x, sampling_results, gt_bboxes,
                            gt_labels, gt_dom_labels, rcnn_train_cfg):
        ...
        bbox_results = self._bbox_forward1(stage, x, rois)
    ...
    def simple_test(self, x, proposal_list, img_metas, rescale=False):
        ...
        for i in range(self.num_stages):
            # bbox_results = self._bbox_forward(i, x, rois)
            bbox_results = self._bbox_forward1(i, x, rois)
