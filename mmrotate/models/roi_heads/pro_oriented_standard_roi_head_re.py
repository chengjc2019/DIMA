...
class ProOrientedStandardRoIHeadRe(RotatedStandardRoIHead):
    ...
    def simple_test(self, x, proposal_list, img_metas, rescale=False):
        ...
        det_bboxes, det_labels, coarse_results = self.simple_test_bboxes(
        ...
        return bbox_results, coarse_results
