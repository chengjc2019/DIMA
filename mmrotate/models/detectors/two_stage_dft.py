...
class RotatedTwoStageDetectorDFT(RotatedBaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(RotatedTwoStageDetectorDFT, self).__init__(init_cfg)
        if pretrained:
    ...
    def forward_train(self,
        ...
        if mode == "DFT":
            ...
            roi_losses_o = self.roi_head.forward_train(x, img_metas, proposal_list_o,
                                                       ...
                                                       **kwargs)
            roi_losses_l = self.roi_head.forward_train1(x_l, img_metas, proposal_list_l,
                                                       gt_bboxes, gt_labels,
                                                       gt_bboxes_ignore, gt_masks,
                                                       **kwargs)
            ...
            roi_losses_o = self.roi_head.forward_train(x, img_metas, proposal_list_o,
                                                       ...
                                                       gt_bboxes_ignore, gt_masks,
                                                       **kwargs)
            roi_losses_l = self.roi_head.forward_train(x_l, img_metas, proposal_list_l,
                                                       gt_bboxes, gt_labels,
                                                       gt_bboxes_ignore, gt_masks,
                                                       **kwargs)
            ...
            losses = dft.cal_losses_l(losses_o, losses_l)
            return losses
        elif mode == "DFT_h":
            img_l, img_h = dft.DFTImg(img.clone())
            x = self.extract_feat(img)
            ...
            roi_losses_o = self.roi_head.forward_train(x, img_metas, proposal_list_o,
                                                       ...
                                                       gt_bboxes_ignore, gt_masks,
                                                       **kwargs)
            roi_losses_h = self.roi_head.forward_train(x_h, img_metas, proposal_list_h,
                                                       gt_bboxes, gt_labels,
                                                       gt_bboxes_ignore, gt_masks,
                                                       **kwargs)
            ...
            losses = dft.cal_losses_h(losses_o, losses_h)
            return losses
