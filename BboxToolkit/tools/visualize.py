...
def add_parser(parser):
    ...
    # "ann_dir": "/home/chip/mmrotate/work_dirs/orcnn_bs32/eval/benchmark_ss/txt/",
    # "save_dir": "/media/chip/A26A0E196A0DEABD/work_dirs/fair1m/test_vis/orcnn_bs32/no_text/",
    ...
    parser.add_argument('--save_dir', type=str, default="/home/chip/mmrotate/work_dirs/orcnn_trainval/eval/vis",
    ...
    parser.add_argument('--skip_empty', default=False,
                        help='whether show images without objects')
    parser.add_argument('--random_vis', default=False,
                        help='whether to shuffle the order of images')
    parser.add_argument('--ids', type=str, default=None,
                        help='choice id to visualize')
    parser.add_argument('--show_off', default=True,
    ...
    parser.add_argument('--colors', type=str, default='red',
                        help='the thickness for bboxes')
    # "colors": "./vis_configs/fair1m/colors.txt",
